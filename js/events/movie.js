...
window.event_movie = EventEngine.create({
  ...
  dialogues: {
    main: [
      ...
      { choice: [
        { id: 'remember_yes', text: '기억난다',       route: 'Remember' },
        { id: 'remember_no',  text: '기억나지 않는다', route: 'Forget' },
      ] },
    ],
    ...
    Forget: [
      ...
      { choice: [
        { id: 'genre_horror',  text: '공포영화를 보자',   set: { movie_genre: '장마, 홍련' } },
        { id: 'genre_romance', text: '로맨스 영화를 보자', set: { movie_genre: '비누남 이야기' } },
        { id: 'genre_action',  text: '액션 영화를 보자',   set: { movie_genre: '이터널 다크니스' } },
      ] },
      { branch: 'var:movie_genre', cases: {
        '장마, 홍련':     [ { propShow: 'MovieHorror' },  { narration: '화제의 공포영화 장마, 홍련.' } ],
        '비누남 이야기':   [ { propShow: 'MovieRomance' }, { narration: '화제의 로맨스 영화 비누남 이야기.' } ],
        '이터널 다크니스': [ { propShow: 'MovieAction' },  { narration: '화제의 액션 영화 이터널 다크니스.' } ],
      } },
      { propExit: true },
      { speaker: 'mom', text: '그래! 그걸로 보자~', expression: 'smile' },
      { narration: '엄마와 함께 {movie_genre}을/를 보러 상영관으로 들어간다...' },
    ...
    WatchMovie: [
      ...
      { choice: [
        { id: 'act_lean',    text: '엄마에게 살짝 기댄다.',     stats: { 애정: 1, 감정성: 1 } },
        { id: 'act_hand',    text: '엄마의 손을 잡는다.',       stats: { 애정: 1, 감정성: 1 } },
        { id: 'act_popcorn', text: '엄마에게 팝콘을 먹여준다.', stats: { 애정: 2, 감정성: 2 } },
        { id: 'act_none',    text: '아무것도 안한다.' },
      ] },
